...
#' @param group_col Character or `NULL`. Column used to colour bars in the
...
#'   colours. `NULL` auto-generates from `Nour_pal()`.
...
PlotQCMetrics <- function(
  ...
  if ("DoubletStatus" %in% colnames(CellInfo)) {
    ...
    .write_legend_sidecar(f_dbl, paste0(
      ...
      ". Each bar is coloured by sample of origin."
    ))
    message("  Saved: ", f_dbl)
  }
  ...
  grDevices::dev.off()
  # Sidecar auto-generated from template "qualitycontrol"
  message("  Saved: ", f_qc)
  ...
  print(P1)
  grDevices::dev.off()
  # Sidecar auto-generated from template "before filtration"
