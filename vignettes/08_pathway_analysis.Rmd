...
## 8. Finding pathways by keyword - `PlotGSEAEnrichment()`

A GSEA run returns hundreds of pathways with long, exact MSigDB names. You
shouldn't have to know that the apoptosis pathway is called
...
## 9. Which genes drive a pathway? - `VisualizeLeadingEdge()`
